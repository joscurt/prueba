 ...
 * @ORM\Entity(repositoryClass="Jazzyweb\AulasMentor\NotasFrontendBundle\Repository\UsuarioRepository")
 * @UniqueEntity(fields={"email", "username"}, message="There already is such a magazine number.")
 */
